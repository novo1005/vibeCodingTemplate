...
- 摘要与结论规则：摘要必须交代背景和核心结论；关键结论采用“标题给判断 + 数据支撑 + 一句话总结”；摘要和正文结论保持一致。
- 结构与可读性规则：目录或小标题能让读者快速理解报告主线；分点尽量 MECE；结论前置；次要信息用引用或说明弱化；高亮方式全文一致，避免通篇黑体。
- 研究报告 Checklist：检查研究目的、核心问题链、内部/外部信息、数据质量、用户声音、竞品分析维度、论证逻辑、可执行建议和数据来源附录。
...
- 规范检查区：展示摘要、结论、MECE、数据支撑、用户声音、竞品分析、可执行建议、数据来源附录和 AI 痕迹等检查项；每项显示状态、原因、建议改法和是否需要用户补充。
